...
function enqueue_styles_scripts() { 
	wp_enqueue_style( 'foll-style', get_template_directory_uri() . '/build/screen.css', array(), '128' );
	...
	wp_enqueue_script( 'foll-main', get_template_directory_uri() . '/build/js/all.js', array('jquery'),'125', true);	
